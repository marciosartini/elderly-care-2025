            ...
            <CardContent className="pt-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-1">
                  ...
                  <p className="font-medium">{getResidentName(viewingEvolution.residentId)}</p>
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <p className="font-medium">{viewingEvolution.time}</p>
                </div>
              </div>
              
              <div className="space-y-1">
                <Label className="text-muted-foreground">Registrado por</Label>
                <p className="font-medium">{viewingEvolution.userName}</p>
              </div>
